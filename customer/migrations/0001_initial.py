# Generated by Django 4.2 on 2025-03-20 16:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('New Order', 'Nuevo pedido'), ('Items shipped', 'Artículo enviado'), ('Item delivered', 'Artículo entregado')], default=None, max_length=100)),
